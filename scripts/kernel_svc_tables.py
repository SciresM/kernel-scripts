...
SVC_MAPPINGS = {
    ...
    0x18 : ("WaitSynchronization", "Result  %s(int32_t *out_index, const Handle *handles, int32_t num_handles, int64_t timeout_ns);"),
    ...
    0x37 : ("GetResourceLimitPeakValue", "Result  %s(int64_t *out_peak_value, Handle resource_limit_handle, LimitableResource which);"),
    0x39 : ("CreateIoPool", "Result %s(Handle *out_handle, uint32_t which);"),
    0x3A : ("CreateIoRegion", "Result %s(Handle *out_handle, Handle io_pool, PhysicalAddress physical_address, size_t size, MemoryMapping mapping, MemoryPermission perm);"),
    ...
    0x46 : ("MapIoRegion", "Result  %s(Handle iomem_handle, uintptr_t address, size_t size, MemoryPermission perm);"),
    0x47 : ("UnmapIoRegion", "Result  %s(Handle iomem_handle, uintptr_t address, size_t size);"),
